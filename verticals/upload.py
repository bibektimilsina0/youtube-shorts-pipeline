...
def upload_to_youtube(
    ...
    body = {
        ...
        "status": {
            # Defaults to private so a missing/typo'd env var can never
            # accidentally publish. Set YT_PRIVACY=public|unlisted to change.
            "privacyStatus": os.environ.get("YT_PRIVACY") or "private",
